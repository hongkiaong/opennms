...
public class MinionStatusTrackerTest {
    ...
    public void testRefresh() throws Exception {
        ...
        when(m_outageDao.matchingOutages(any(ServiceSelector.class))).thenReturn(outages);
    ...
    public void testRefreshNoOutages() throws Exception {
        ...
        when(m_outageDao.matchingOutages(any(ServiceSelector.class))).thenReturn(Collections.emptyList());
        ...
        assertEquals("node A heartbeat up should be as of " + heartbeatUpDate, statusA.getHeartbeatStatus().lastSeen().getTime(), heartbeatUpDate.getTime());
        ...
        assertEquals("node A RPC up should be as of " + rpcUpDate, statusA.getRpcStatus().lastSeen().getTime(), rpcUpDate.getTime());
